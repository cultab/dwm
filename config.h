...
static const char gappxs[]         = "4";      /* gaps between windows for dmenu */
...
static const char *dmenucmd[]     = { "dmenu_run",   "-m", dmenumon, "-c", "-bw", gappxs, NULL };
static const char *dmenu_query[]  = { "dmenu_query", "-m", dmenumon, "-c", "-bw", gappxs, NULL };
